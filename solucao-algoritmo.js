...
function calcularMedia() {
    ...
    if (media > 6) {
        ...
        elementoResultado.textContent = `Média: ${media.toFixed(2)} - estudante APROVADA`;
        elementoResultado.className = 'aprovada';
    } else {
        document.getElementById('resultado').textContent = `Média: ${media.toFixed(2)} - estudante REPROVADA`;
